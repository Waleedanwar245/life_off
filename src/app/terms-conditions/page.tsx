  ...
  return (
    <>
      ...
      <div className="mt-[100px] max-w-[1000px] mx-auto px-4 py-8 bg-white">
        ...
        <p className="text-sm mb-6 text-gray-600">Last Updated: 18/03/2025</p>
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Use of the Site</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Accuracy of Information</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">External Links</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Limitation of Liability</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Indemnification</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Intellectual Property</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Termination</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Coupon Submission</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <h2 className="text-xl font-bold mb-3 text-gray-800">Changes to the Terms</h2>
        <p className="mb-6 text-sm text-gray-600">
        ...
        <p className="mt-8 pt-4 border-t border-gray-200 text-gray-600 text-sm font-medium">
